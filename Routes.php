...
return [
    ...
    #Api rute:
    App\Core\Route::any('|^api/product/([0-9]+)/?$|',                      'ApiProduct',            'showProductById'),
    App\Core\Route::any('|^api/bookmarks/?$|',                             'ApiBookmark',            'getBookmarks'),
    App\Core\Route::any('|^api/bookmarks/clear/?$|',                       'ApiBookmark',            'clear'),
    App\Core\Route::any('|^api/bookmarks/add/([0-9]+)/?$|',                 'ApiBookmark',            'addBookmark'),
