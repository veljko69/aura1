...
class ProductController extends Controller
{
      ...
      public function addProduct()
      {
            ...
            $materijal = $_POST['prouct_materijal'];
...
//        $productModel = new ProductModel($dbc);
            ...
            $productModel->editProduct($id,$tip, $naziv, $cijena,  $pol,$v1,$v2,$v3,$v4,$v5,$v6,$v7,$v8, $sifra, $boja,$materijal, $slika);

            $this->redirect("/aura1/admin");

      }
//      public function postEditKolicina($id){
//
////        $dbc = $this->getDatabaseConnection();
////        $productModel = new ProductModel($dbc);
//
...
//
//
//            $kolicina      = filter_input(INPUT_POST,'product_kolicina',FILTER_SANITIZE_STRING);
//
//
//            $productModel->editKolicina($id, $kolicina);
//
//            $this->redirect("/aura1/admin");
//
//      }
